...
router.get('/', (req, res) =>
{
    ...
    {
        con.query("SELECT ids_soil_ph FROM plants WHERE id = " + plant_id).then(result => {
            ...
            transformSoilPHToValue(ids).then(function (returnValue) { res.status(200).json(returnValue); },
