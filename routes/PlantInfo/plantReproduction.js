...
router.get('/', (req, res) =>
{
    ...
    {
        con.query("SELECT ids_reproduction FROM plants WHERE id = " + plant_id).then(result => {
            ...
            transformReproductionToValue(ids).then(function (returnValue) { res.status(200).json(returnValue); },
