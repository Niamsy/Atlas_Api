...
router.post('/', (req, res) => {
    ...
    if (req.body["name"] === undefined ||
        ...
        req.body["ids_soil_type"] === undefined ||
        req.body["ids_sun_exposure"] === undefined ||
        req.body["ids_soil_humidity"] === undefined ||
        req.body["ids_reproduction"] === undefined ||
        req.body["ids_plant_container"] === undefined ||
        req.body["planting_period"] === undefined ||
        req.body["florering_period"] === undefined ||
        req.body["harvest_period"] === undefined ||
        req.body["cutting_period"] === undefined ||
        req.body["fk_id_frozen_tolerance"] === undefined ||
        req.body["fk_id_growth_rate"] === undefined ||
        req.body["growth_duration"] === undefined)
    {
        res.status(400).json({
